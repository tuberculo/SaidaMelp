LeTermOper <- function(CaminhoArquivoTermOper = "../Caso060/MelpResul/TermOper.out") {
  ...
  GeraTerm <- left_join(GeraTerm, Patamar, by = c("Ano" = "Ano", "Pat" = "Pat", "PERZ" = "Trimestre"))
  GeraTerm <- mutate(GeraTerm, GeraEner = GeraPot * DuraPatTri) # Geração em energia
}