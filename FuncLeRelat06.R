LeRelat06 <- function(NomeArquivo = "Melp.out"){
  ...
  BalancoTotal <- left_join(BalancoTotal, Patamar, by = c("Ano", "Patamar" = "Pat", "Estacao" = "Trimestre")) %>% mutate(GeraHidrEnerg = GeraHidr * DuraPatTri, GeraTerEnerg = GeraTer * DuraPatTri)
}
#ANO:  2019 - ESTACAO: